...
local tbcObjectiveLocales = {
    ["Defeat Centaur to summon Warlord Krom'zar"] = { -- 4021
        ...
        ["koKR"] = "켄타우로스를 처치하여 전쟁군주 크롬자르를 소환하세요",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Place the Infused Crystal and protect it from the Scourge for 1 minute"] = { -- 8490
        ...
        ["koKR"] = "주입된 수정을 놓고 1분 동안 스컬지로부터 보호",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Sanctified Crystal against a wounded Uncontrolled Voidwalker"] = { -- 9383
        ...
        ["koKR"] = "구속이 풀린 보이드워커에게 정화된 수정을 사용하세요.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Wolf Totem at the location where you found Krun Spinebreaker's body and follow the Ancestral Spirit Wolf."] = { -- 9410
        ...
        ["koKR"] = "크룬 스파인브레이커의 시체를 발견한 장소에서 토템을 사용한 후, 고대의 늑대 정령을 따라가기",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Take Avruu's Orb to the Haal'eshi Altar"] = { -- 9418
        ...
        ["koKR"] = "하알에쉬 제단으로 아브루의 구슬을 가져가, 아에라나스가 풀려나면 그에게 건네주기.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Robotron Control near the Concealed Command Console hidden in a small cluster of bushes"] = { -- 9433
        ...
        ["koKR"] = "작은 수풀 군락에 숨겨진 은폐된 명령 콘솔 근처에서 로보트론 제어장치을 사용.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Gift of Naias near the Altar of Naias"] = { -- 9457
        ...
        ["koKR"] = "나이아스의 제단 근처에서 나이아스의 선물을 사용",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Pickpocket the Lacy Handkerchief from the Sentinel Leader"] = { -- 9460
        ...
        ["koKR"] = "파수대 지휘관의 레이스 손수건을 몰래 훔쳐오기",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Destroy all 4 Sunhawk Portal Controller"] = { -- 9740
        ...
        ["koKR"] = "4개의 '태양매 차원문 제어술사'를 모두 파괴하십시오",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use Gordawg's Boulder to shatter Shattered Rumblers into Minions of Gurok"] = { -- 9849
        ...
        ["koKR"] = "고르다우그의 바위를 사용, 구로크의 하수인 처치",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use 7 Warmaul Skulls to summon Gurok the Usurper"] = { -- 9853
        ...
        ["koKR"] = "전쟁망치일족 해골 7개를 구해,약탈자 구로크를 소환.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Apex's Crystal Focus near Archmage Vargoth's Orb"] = { -- 10256
        ...
        ["koKR"] = "바르고스의 수정구슬 근처에서 에이펙스의 수정 초점을 사용",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Soul Mirror near Ancient Orc Ancestors to summon Darkened Spirits."] = { -- 10168
        ...
        ["koKR"] = "고대 오크 선조에게 사용을 사용,어둠의 영혼 15명을 파괴.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Blow the Unyielding Battle Horn near the Alliance Banner"] = { -- 10250
        ...
        ["koKR"] = "얼라이언스 깃발 근처에서 불굴의 전투 뿔피리를 사용",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use the Cenarion Antidote on a Hulking Helboar and observe the results"] = { -- 10255
        ...
        ["koKR"] = "덩치 큰 지옥멧돼지에게 세나리온 해독제를 사용하고 관찰",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Obtain the Coruu Access Crystal from Overseer Seylanna. Use it at the Manaforge Coruu Console to shut it down"] = { -- 10321 & 10330
        ...
        ["koKR"] = "감독관 테레디스에게서 '브나르 장치 접근 수정'을 입수, 수정을 사용하여 브나르 마나괴철로 제어장치를 차단.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Obtain the Ara Access Crystal from Overseer Azarad. Use it at the Manaforge Ara console to shut it down"] = { -- 10323 & 10365
        ...
        ["koKR"] = "감독관 아자라드에게서 아라 장치 접근 수정을 입수. 제어장치에 사용하여 괴철로를 차단.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Socrethar's Teleportation Stone creates a portal, teleporting group members that use it to Socrethar's Seat"] = { -- 10409 & 10507
        ...
        ["koKR"] = "소크레타르의 순간이동석을 사용/이동후 소크레타르 처치.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
    ...
    ["Use Navuud's Concoction before attacking Void Wastes or Seeping Sludge"] = { -- 10411
        ...
        ["koKR"] = "나부드 혼합물을 사용, 공허 황무지,스며나오는 침전물을 공격.",
        ["esMX"] = false,
        ["enUS"] = true,
        ["frFR"] = false,
        ["esES"] = false,
