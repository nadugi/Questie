...
local socialOptionsLocales = {
    ...
    ["Announce quest updates to other players in your group or raid"] = {
        ...
        ["koKR"] = "그룹 또는 공격대에 있는 다른 플레이어에게 퀘스트 업데이트를 알립니다.",
        ["enUS"] = true,
    ...
    ["Remove all Questie chat messages coming from other players and disable sending your own."] = {
        ...
        ["koKR"] = "다른 플레이어에서 오는 모든 Questy 채팅 메시지를 제거하고 자신의 메시지를 보내는 것을 비활성화합니다.",
    ...
    ["Announce looted items that start a quest to other players"] = {
        ...
        ["koKR"] = "퀘스트를 시작하는 전리품을 다른 플레이어에게 알립니다.",
