...
local searchLocales = {
    ...
    ["This item is blacklisted because it has too many sources"] = {
        ...
        ["koKR"] = "이 항목은 소스가 너무 많아 블랙리스트에 있습니다.",
